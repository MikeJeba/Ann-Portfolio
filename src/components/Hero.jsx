    ...
    <div className='pb-4 lg:mb-360'>
        <div className='flex flex-wrap lg:flex-row-reverse'>
            ...
            <div className='flex justify-center lg:p-8'>
                <motion.img src={profilePic} alt="Ann" className='border border-orange-900 rounded-3xl'
                width={600}
                height={500}
            ...
            className='flex flex-col items-center lg:items-start mt-10'>
                ...
                <motion.a 
                variants={childVariants}
                href="/Ann Jeba Jovitha.pdf" target='_blank' rel='noopener noreferrer'
                download
                className='bg-white rounded-full p-4 text-sm text-gray-800 mb-10'
